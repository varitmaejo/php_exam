    ...
    if (empty($errors)) {
        try {
            ...
            if ($update_stmt->execute([$fullname, $gender, $curriculum_id, $class_room, $email, $phone, $photo_name, $student_id])) {
                ...
                echo "<script>setTimeout(function(){ window.location.href = 'view_student.php?id=" . urlencode($student_id) . "'; }, 2000);</script>";
            } else {
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="view_student.php?id=<?= urlencode($student_id) ?>" class="btn btn-secondary me-md-2">ยกเลิก</a>
